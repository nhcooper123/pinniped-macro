...
\begin{figure}[H]
  ...
  \caption{All pinnipeds excluding sampled ancestors. $\lambda_{prior} = 0.01$. Left, middle and right panels indicate speciation, extinction and net diversification rates, respectively.}
  \label{fig-noanc-10}
\end{figure}As currently written it was too narrowly focused. The claimed generality of the methods they are presenting did not come through - most of it was hidden in the supplementary materials. So they would need to completely overhaul the paper to stand a chance, as the reviewers weren’t impressed with the current version. 
...
\begin{figure}[H]
  \centering
  \includegraphics[width = \linewidth]{figures/diversification/main-analyses-with-sampled-ancestors/main-analysis-with-sampled-ancestors.png}
