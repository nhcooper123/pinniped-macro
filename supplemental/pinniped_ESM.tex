...
\title{Supplementary Materials from: \textit{Fossils improve our understanding of evolutionary patterns in pinnipeds}} 
...
Taxon names have been removed from Figures \ref{fig-noanc-0-01}-\ref{fig-fossil-only-full} for readability.
