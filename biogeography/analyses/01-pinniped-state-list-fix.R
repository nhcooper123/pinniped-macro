...
# Make the stratum-specific states list
states_list_0based_1B <- states_list_0based[keep1B]
...
# Make the stratum-specific states list
states_list_0based_2A <- states_list_0based[keep2A]
...
# Make the stratum-specific states list
states_list_0based_2B <- states_list_0based[keep2B]
...
# Make the stratum-specific states list
states_list_0based_3A <- states_list_0based[keep3A]
...
# Make the stratum-specific states list
states_list_0based_3B <- states_list_0based[keep3B]

#----------------------------------------------
# TIME BIN 4 (5.97 Ma)
#----------------------------------------------
# Identify non-adjacent ranges (impossible only)
nonadjacent4A <- c("AH", "AI", "BI", "CI", "DI", "EI", "FI", "GI", "HI", "I")
# Extract from range list
keep4A <- ranges_list %in% nonadjacent4A == FALSE
ranges_list_4A <- ranges_list[keep4A]
# Make the stratum-specific states list
states_list_0based_4A <- states_list_0based[keep4A]

# Identify non-adjacent ranges (impossible and unlikely)
nonadjacent4B <- c("AH", "AI", "BI", "CI", "DI", "EI", "FI", "GI", "HI", "I", "AE", "AF", "AG", 
                   "BD", "BE", "BF", "BH", "CD", "CE", "CH", "DF", "DG", "FH", "GH")
# Extract from range list
keep4B <- ranges_list %in% nonadjacent4B == FALSE
ranges_list_4B <- ranges_list[keep4B]
# Make the stratum-specific states list
states_list_0based_4B <- states_list_0based[keep4B]

#----------------------------------------------
# TIME BIN 5 (13.82 Ma)
#----------------------------------------------
# Same as time bin 3
states_list_0based_5A <- states_list_0based_3A
states_list_0based_5B <- states_list_0based_3B
...
# Make the stratum-specific states list
states_list_0based_6A <- states_list_0based[keep6A]
...
# Make the stratum-specific states list
states_list_0based_6B <- states_list_0based[keep6B]

#----------------------------------------------
# TIME BIN 7 (20.44 Ma)
#----------------------------------------------
# Same as time bin 3
states_list_0based_7A <- states_list_0based_3A
states_list_0based_7B <- states_list_0based_3B

#----------------------------------------------
# TIME BIN 8 (37.8 Ma)
#----------------------------------------------
# Same as time bin 6
states_list_0based_8A <- states_list_0based_6A
states_list_0based_8B <- states_list_0based_6B
