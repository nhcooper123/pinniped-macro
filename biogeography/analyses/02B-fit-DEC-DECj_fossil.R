...
#----------------------------------
# Impossible removed only
resfn_fossil <- "pinnipeds-fossil-DEC_9areas_impossible.Rdata"
res_fossil <- bears_optim_run(BioGeoBEARS_run_object)
res_fossil    
save(res_fossil, file = resfn_fossil)
resDEC_fossil <- res_fossil

# Impossible and unlikely removed
#resfn1_fossil <- "pinnipeds-fossil-DEC_9areas_neither.Rdata"
#res1_fossil <- bears_optim_run(BioGeoBEARS_run_object)
#res1_fossil    
#save(res1_fossil, file = resfn1_fossil)
#resDEC1_fossil <- res1_fossil
#----------------------------------
# SETUP DEC+J
#----------------------------------
BioGeoBEARS_run_object <- define_BioGeoBEARS_run()
