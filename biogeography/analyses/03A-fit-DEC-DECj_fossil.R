...
#----------------------------------
# Impossible removed only
resfn_fossil <- "biogeography/outputs/pinnipeds-fossil-DEC_9areas_impossible.Rdata"
resDEC_fossil <- bears_optim_run(BioGeoBEARS_run_object)
resDEC_fossil    
save(resDEC_fossil, file = resfn_fossil)
...
dstart <- resDEC_fossil$outputs@params_table["d","est"]
estart <- resDEC_fossil$outputs@params_table["e","est"]
jstart <- 0.0001
