...
library("BAMMtools")
library("phytools")
here::i_am("diversification/R/fossilbamm_results_extant.R")

tree.pinnip <- read.tree(here::here("diversification/data/pinniped_median_extant.tre"))

mcmcout <- read.csv(here::here("diversification/analyses/extant_only/mcmc_out_pinnipedia_extant.txt"), header = TRUE)
mcmcout <- mcmcout[floor(0.1 * nrow(mcmcout)):nrow(mcmcout),]
coda::effectiveSize(mcmcout$logLik)
coda::effectiveSize(mcmcout$N_shifts)

edata.pinnip <- getEventData(tree.pinnip, here::here("diversification/analyses/extant_only/event_data_pinnipedia_extant.txt"), burnin = 0.1)

summary(edata.pinnip)

png(here::here("supplemental/figures/diversification/extant_only/phylo_rates_pinnipedia_extant_speciation.png"), width = 4, height = 5.5, units = "in", res = 300)
...
png(here::here("supplemental/figures/diversification/extant_only/phylo_rates_pinnipedia_extant_extinction.png"), width = 4, height = 5.5, units = "in", res = 300)
...
png(here::here("supplemental/figures/diversification/extant_only/phylo_rates_pinnipedia_extant_netdiv.png"), width = 4, height = 5.5, units = "in", res = 300)
...
## png(here::here("supplemental/figures/diversification/extant_only/css_pinnipedia_extant.png"), width = 9, height = 9, units = "in", res = 300)
...
## png(here::here("supplemental/figures/diversification/extant_only/rtt_speciation_pinnipedia_extant.png"), width = 9, height = 9, units = "in", res = 300)
## plotRateThroughTime(edata.pinnip, ratetype = "speciation", intervalCol = "#CC6677", avgCol = "#CC6677")
## dev.off()

## png(here::here("supplemental/figures/diversification/extant_only/rtt_extinction_pinnipedia_extant.png"), width = 9, height = 9, units = "in", res = 300)
## plotRateThroughTime(edata.pinnip, ratetype = "extinction", intervalCol = "#CC6677", avgCol = "#CC6677")
## dev.off()

## png(here::here("supplemental/figures/diversification/extant_only/rtt_netdiv_pinnipedia_extant.png"), width = 9, height = 9, units = "in", res = 300)
...
## png(here::here("supplemental/figures/diversification/main_analysis_with_sampled_ancestors/rtt_extant_speciation_pinnipedia_per_family.png"), width = 9, height = 9, units = "in", res = 300)
...
## png(here::here("supplemental/figures/diversification/main_analysis_with_sampled_ancestors/rtt_extant_extiction_pinnipedia_per_family.png"), width = 9, height = 9, units = "in", res = 300)
...
## png(here::here("supplemental/figures/diversification/main_analysis_with_sampled_ancestors/rtt_extant_netdiv_pinnipedia_per_family.png"), width = 9, height = 9, units = "in", res = 300)
