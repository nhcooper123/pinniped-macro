...
library("BAMMtools")
library("phytools")
here::i_am("diversification/R/fossilbamm_results_full.R")

tree.pinnip <- read.tree(here::here("diversification/data/pinniped_median_full.tre"))

mcmcout <- read.csv(here::here("diversification/analyses/main_analysis_with_sampled_ancestors/mcmc_out_pinnipedia_full.txt"), header = TRUE)
mcmcout <- mcmcout[floor(0.1 * nrow(mcmcout)):nrow(mcmcout),]
coda::effectiveSize(mcmcout$logLik)
coda::effectiveSize(mcmcout$N_shifts)

edata.pinnip <- getEventData(tree.pinnip, here::here("diversification/analyses/main_analysis_with_sampled_ancestors/event_data_pinnipedia_full.txt"), burnin = 0.1)

post_probs <- table(mcmcout$N_shifts) / nrow(mcmcout)

summary(edata.pinnip)

png(here::here("supplemental/figures/diversification/main-analysis-with-sampled-ancestors/phylo-rates-pinnipedia-full-speciation.png"), width = 4, height = 5.5, units = "in", res = 300)
...
png(here::here("supplemental/figures/diversification/main-analysis-with-sampled-ancestors/phylo-rates-pinnipedia-full-extinction.png"), width = 4, height = 5.5, units = "in", res = 300)
...
png(here::here("supplemental/figures/diversification/main-analysis-with-sampled-ancestors/phylo-rates-pinnipedia-full-netdiv.png"), width = 4, height = 5.5, units = "in", res = 300)
...
## png(here::here("supplemental/figures/diversification/main_analysis_with_sampled_ancestors/css_pinnipedia_full.png"), width = 9, height = 9, units = "in", res = 300)
...
## png(here::here("supplemental/figures/diversification/main_analysis_with_sampled_ancestors/rtt_speciation_pinnipedia_full.png"), width = 9, height = 9, units = "in", res = 300)
## plotRateThroughTime(edata.pinnip, ratetype = "speciation", intervalCol = "#CC6677", avgCol = "#CC6677")
## dev.off()

## png(here::here("supplemental/figures/diversification/main_analysis_with_sampled_ancestors/rtt_extinction_pinnipedia_full.png"), width = 9, height = 9, units = "in", res = 300)
## plotRateThroughTime(edata.pinnip, ratetype = "extinction", intervalCol = "#CC6677", avgCol = "#CC6677")
## dev.off()

## png(here::here("supplemental/figures/diversification/main_analysis_with_sampled_ancestors/rtt_netdiv_pinnipedia_full.png"), width = 9, height = 9, units = "in", res = 300)
...
## png(here::here("supplemental/figures/diversification/main_analysis_with_sampled_ancestors/rtt_full_speciation_pinnipedia_per_family.png"), width = 9, height = 9, units = "in", res = 300)
...
## png(here::here("supplemental/figures/diversification/main_analysis_with_sampled_ancestors/rtt_full_extiction_pinnipedia_per_family.png"), width = 9, height = 9, units = "in", res = 300)
...
## png(here::here("supplemental/figures/diversification/main_analysis_with_sampled_ancestors/rtt_full_netdiv_pinnipedia_per_family.png"), width = 9, height = 9, units = "in", res = 300)
