...
png(here::here("supplemental/figures/diversification/main_analysis_with_sampled_ancestors/phylo_rates_pinnipedia_full_speciation.png"), width = 4, height = 5.5, units = "in", res = 300)
...
png(here::here("supplemental/figures/diversification/main_analysis_with_sampled_ancestors/phylo_rates_pinnipedia_full_extinction.png"), width = 4, height = 5.5, units = "in", res = 300)
...
png(here::here("supplemental/figures/diversification/main_analysis_with_sampled_ancestors/phylo_rates_pinnipedia_full_netdiv.png"), width = 4, height = 5.5, units = "in", res = 300)
