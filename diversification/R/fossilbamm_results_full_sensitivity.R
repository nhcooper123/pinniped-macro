...
for(i in 1:length(shifts.prob)){
    ...
    png(here::here(paste0("supplemental/figures/diversification/sensitivity-analyses-with-sampled-ancestors/shifts-", gsub(".", "-", shifts.prob[i], fixed = TRUE), "/phylo-rates-pinnipedia-full-speciation-", gsub(".", "-", shifts.prob[i], fixed = TRUE), ".png")), width = 4, height = 5.5, units = "in", res = 300)
    ...
    png(here::here(paste0("supplemental/figures/diversification/sensitivity-analyses-with-sampled-ancestors/shifts-", gsub(".", "-", shifts.prob[i], fixed = TRUE), "/phylo-rates-pinnipedia-full-extinction-", gsub(".", "-", shifts.prob[i], fixed = TRUE), ".png")), width = 4, height = 5.5, units = "in", res = 300)
    ...
    png(here::here(paste0("supplemental/figures/diversification/sensitivity-analyses-with-sampled-ancestors/shifts-", gsub(".", "-", shifts.prob[i], fixed = TRUE), "/phylo-rates-pinnipedia-full-netdiv-", gsub(".", "-", shifts.prob[i], fixed = TRUE), ".png")), width = 4, height = 5.5, units = "in", res = 300)
    ...
    ## png(here::here(paste0("supplemental/figures/diversification/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/css_pinnipedia_full_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".png")), width = 9, height = 9, units = "in", res = 300)
    ...
    ## png(here::here(paste0("supplemental/figures/diversification/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/rtt_extinction_pinnipedia_full_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".png")), width = 9, height = 9, units = "in", res = 300)
    ## plotRateThroughTime(edata.pinnip, ratetype = "extinction", intervalCol = "#CC6677", avgCol = "#CC6677")
    ## dev.off()

    ## png(here::here(paste0("supplemental/figures/diversification/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/rtt_netdiv_pinnipedia_full_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".png")), width = 9, height = 9, units = "in", res = 300)
    ...
    ## png(here::here(paste0("supplemental/figures/diversification/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/rtt_speciation_pinnipedia_full_per_family_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".png")), width = 9, height = 9, units = "in", res = 300)
    ...
    ## png(here::here(paste0("supplemental/figures/diversification/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/rtt_extinction_pinnipedia_full_per_family_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".png")), width = 9, height = 9, units = "in", res = 300)
    ...
    ## png(here::here(paste0("supplemental/figures/diversification/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/rtt_netdiv_pinnipedia_full_per_family_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".png")), width = 9, height = 9, units = "in", res = 300)
