...
library("BAMMtools")
library("phytools")
here::i_am("diversification/R/fossilbamm_results_full_sensitivity.R")

tree.pinnip <- read.tree(here::here("diversification/data/pinniped_median_full.tre"))

shifts.prob <- c(0.01, 0.1, 0.5, 2, 10)

for(i in 1:length(shifts.prob)){
    print(paste(i, "out of", length(shifts.prob)))
    mcmcout <- read.csv(here::here(paste0("diversification/analyses/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/mcmc_out_pinnipedia_full_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".txt")), header = TRUE)
    mcmcout <- mcmcout[floor(0.1 * nrow(mcmcout)):nrow(mcmcout),]
    coda::effectiveSize(mcmcout$logLik)
    coda::effectiveSize(mcmcout$N_shifts)

    edata.pinnip <- getEventData(tree.pinnip, here::here(paste0("diversification/analyses/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/event_data_pinnipedia_full_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".txt")), burnin = 0.1)

    post_probs <- table(mcmcout$N_shifts) / nrow(mcmcout)

    summary(edata.pinnip)

    png(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/phylo_rates_pinnipedia_full_speciation_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".png")), width = 9, height = 9, units = "in", res = 300)
    ...
    png(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/phylo_rates_pinnipedia_full_extinction_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".png")), width = 9, height = 9, units = "in", res = 300)
    plot.bammdata(edata.pinnip, lwd = 2, legend = TRUE, xlim = c(0, 45), pal = parula(20)[-c(18:20)], spex = "e");axisPhylo()
    tiplabels(edata.pinnip$tip.label, frame = "none", bg = NULL, adj = c(-0.1, 0.5), cex = 0.75)
    addBAMMshifts(edata.pinnip)
    dev.off()

    png(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/phylo_rates_pinnipedia_full_netdiv_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".png")), width = 9, height = 9, units = "in", res = 300)
    ...
    png(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/css_pinnipedia_full_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".png")), width = 9, height = 9, units = "in", res = 300)
    ...
    png(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/rtt_speciation_pinnipedia_full_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".png")), width = 9, height = 9, units = "in", res = 300)
    plotRateThroughTime(edata.pinnip, ratetype = "speciation", intervalCol = "#CC6677", avgCol = "#CC6677")
    dev.off()

    png(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/rtt_extinction_pinnipedia_full_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".png")), width = 9, height = 9, units = "in", res = 300)
    plotRateThroughTime(edata.pinnip, ratetype = "extinction", intervalCol = "#CC6677", avgCol = "#CC6677")
    dev.off()

    png(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/rtt_netdiv_pinnipedia_full_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".png")), width = 9, height = 9, units = "in", res = 300)
    ...
    png(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/rtt_speciation_pinnipedia_full_per_family_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".png")), width = 9, height = 9, units = "in", res = 300)
    ...
    png(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/rtt_extinction_pinnipedia_full_per_family_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".png")), width = 9, height = 9, units = "in", res = 300)
    ...
    png(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/rtt_netdiv_pinnipedia_full_per_family_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".png")), width = 9, height = 9, units = "in", res = 300)
