...
for(i in 1:length(shifts.prob)){
    ...
    pdf(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/phylo_rates_pinnipedia_full_speciation_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".pdf")), width = 9, height = 9)
    ...
    pdf(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/phylo_rates_pinnipedia_full_extinction_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".pdf")), width = 9, height = 9)
    plot.bammdata(edata.pinnip, lwd = 2, legend = TRUE, xlim = c(0, 45), pal = parula(20)[-c(18:20)], spex = "e");axisPhylo()
    tiplabels(edata.pinnip$tip.label, frame = "none", bg = NULL, adj = c(-0.1, 0.5), cex = 0.75)
    addBAMMshifts(edata.pinnip)
    dev.off()

    pdf(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/phylo_rates_pinnipedia_full_netdiv_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".pdf")), width = 9, height = 9)
    ...
    pdf(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/css_pinnipedia_full_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".pdf")), width = 9, height = 9)
    ...
    pdf(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/rtt_speciation_pinnipedia_full_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".pdf")), width = 9, height = 9)
    plotRateThroughTime(edata.pinnip, ratetype = "speciation", intervalCol = "#CC6677", avgCol = "#CC6677")
    dev.off()

    pdf(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/rtt_extinction_pinnipedia_full_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".pdf")), width = 9, height = 9)
    plotRateThroughTime(edata.pinnip, ratetype = "extinction", intervalCol = "#CC6677", avgCol = "#CC6677")
    dev.off()

    pdf(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/rtt_netdiv_pinnipedia_full_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".pdf")), width = 9, height = 9)
    ...
    pdf(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/rtt_speciation_pinnipedia_full_per_family_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".pdf")), width = 9, height = 9)
    ...
    pdf(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/rtt_extinction_pinnipedia_full_per_family_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".pdf")), width = 9, height = 9)
    ...
    pdf(here::here(paste0("diversification/outputs/figs/sensitivity_analyses_with_sampled_ancestors/shifts_", gsub(".", "_", shifts.prob[i], fixed = TRUE), "/rtt_netdiv_pinnipedia_full_per_family_", gsub(".", "_", shifts.prob[i], fixed = TRUE), ".pdf")), width = 9, height = 9)
