...
png(here::here("diversification/outputs/figs/fossil_only/phylo_rates_pinnipedia_fossil_noanc_speciation.png"), width = 9, height = 9, units = "in", res = 300)
...
png(here::here("diversification/outputs/figs/fossil_only/phylo_rates_pinnipedia_fossil_noanc_extinction.png"), width = 9, height = 9, units = "in", res = 300)
plot.bammdata(edata.pinnip, lwd = 2, legend = TRUE, xlim = c(0, 45), pal = parula(20)[-c(18:20)], spex = "e");axisPhylo()
tiplabels(edata.pinnip$tip.label, frame = "none", bg = NULL, adj = c(-0.1, 0.5), cex = 0.75)
addBAMMshifts(edata.pinnip)
dev.off()

png(here::here("diversification/outputs/figs/fossil_only/phylo_rates_pinnipedia_fossil_noanc_netdiv.png"), width = 9, height = 9, units = "in", res = 300)
...
png(here::here("diversification/outputs/figs/fossil_only/css_pinnipedia_fossil_noanc.png"), width = 9, height = 9, units = "in", res = 300)
...
png(here::here("diversification/outputs/figs/fossil_only/rtt_speciation_pinnipedia_fossil_noanc.png"), width = 9, height = 9, units = "in", res = 300)
plotRateThroughTime(edata.pinnip, ratetype = "speciation", intervalCol = "#CC6677", avgCol = "#CC6677")
dev.off()

png(here::here("diversification/outputs/figs/fossil_only/rtt_extinction_pinnipedia_fossil_noanc.png"), width = 9, height = 9, units = "in", res = 300)
plotRateThroughTime(edata.pinnip, ratetype = "extinction", intervalCol = "#CC6677", avgCol = "#CC6677")
dev.off()

png(here::here("diversification/outputs/figs/fossil_only/rtt_netdiv_pinnipedia_fossil_noanc.png"), width = 9, height = 9, units = "in", res = 300)
...
## png(here::here("diversification/outputs/figs/main_analysis_with_sampled_ancestors/rtt_fossil_full_speciation_pinnipedia_per_family.png"), width = 9, height = 9, units = "in", res = 300)
...
## png(here::here("diversification/outputs/figs/main_analysis_with_sampled_ancestors/rtt_fossil_full_extiction_pinnipedia_per_family.png"), width = 9, height = 9, units = "in", res = 300)
...
## png(here::here("diversification/outputs/figs/main_analysis_with_sampled_ancestors/rtt_fossil_full_netdiv_pinnipedia_per_family.png"), width = 9, height = 9, units = "in", res = 300)
