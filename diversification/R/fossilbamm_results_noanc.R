...
## png(here::here("supplemental/figures/diversification/main_analysis/css_pinnipedia_noanc.png"), width = 9, height = 9, units = "in", res = 300)
...
## #png(here::here("supplemental/figures/diversification/main_analysis/rtt_speciation_pinnipedia_noanc.png"), width = 9, height = 3, units = "in", res = 300)
## pdf(here::here("supplemental/figures/diversification/main_analysis/rtt_speciation_pinnipedia_noanc_panel.pdf"), width = 9, height = 4)
...
## #png(here::here("supplemental/figures/diversification/main_analysis/rtt_extinction_pinnipedia_noanc.png"), width = 9, height = 3, units = "in", res = 300)
## pdf(here::here("supplemental/figures/diversification/main_analysis/rtt_extinction_pinnipedia_noanc_panel.pdf"), width = 9, height = 4)
## plotRateThroughTime(edata.pinnip, ratetype = "extinction", intervalCol = "#CC6677", avgCol = "#CC6677", ylim = c(-0.1, 0.5))
## abline(h = 0, lwd = 2, lty = 2, col = "grey")
## dev.off()

## #png(here::here("supplemental/figures/diversification/main_analysis/rtt_netdiv_pinnipedia_noanc.png"), width = 9, height = 9, units = "in", res = 300)
## pdf(here::here("supplemental/figures/diversification/main_analysis/rtt_netdiv_pinnipedia_noanc_panel.pdf"), width = 9, height = 4)
...
## #png(here::here("supplemental/figures/diversification/main_analysis/rtt_noanc_speciation_pinnipedia_per_family.png"), width = 9, height = 9, units = "in", res = 300)
## pdf(here::here("supplemental/figures/diversification/main_analysis/rtt_noanc_speciation_pinnipedia_per_family.pdf"), width = 6, height = 4)
...
## #png(here::here("supplemental/figures/diversification/main_analysis/rtt_noanc_extinction_pinnipedia_per_family.png"), width = 9, height = 9, units = "in", res = 300)
## pdf(here::here("supplemental/figures/diversification/main_analysis/rtt_noanc_extinction_pinnipedia_per_family.pdf"), width = 6, height = 4)
...
## #png(here::here("supplemental/figures/diversification/main_analysis/rtt_noanc_netdiv_pinnipedia_per_family.png"), width = 9, height = 9, units = "in", res = 300)
## pdf(here::here("supplemental/figures/diversification/main_analysis/rtt_noanc_netdiv_pinnipedia_per_family.pdf"), width = 6, height = 4)
## plotRateThroughTime(edata.pinnip, intervalCol = NULL, avgCol = NULL, ylim = c(-0.1, 0.4), lwd = 4)
